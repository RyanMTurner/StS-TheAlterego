...
public class AlteregoPunishment extends AbstractPower {
    public AbstractCreature source;

    public static final String POWER_ID = "alterego_mod:PunishmentPower";
    ...
    public AlteregoPunishment(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;

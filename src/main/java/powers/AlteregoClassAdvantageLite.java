...
public class AlteregoClassAdvantageLite extends AbstractPower {
    public AbstractCreature source;

    public static final String POWER_ID = "alterego_mod:ClassAdvantageLitePower";
    ...
    public int onAttacked(DamageInfo info, int damageAmount) {
        return (int) Math.ceil (damageAmount * .90);
    }

    @Override
    public float atDamageGive(float damage, DamageInfo.DamageType type) {
        return type == DamageInfo.DamageType.NORMAL ? damage * 1.1F : damage;
    }

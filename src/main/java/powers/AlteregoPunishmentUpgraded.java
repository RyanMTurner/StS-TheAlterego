...
public class AlteregoPunishmentUpgraded extends AbstractPower {
    ...
    public void atEndOfTurn(boolean isPlayer) {
        if (isPlayer) {
            this.addToTop(new LoseHPAction(AbstractDungeon.player, AbstractDungeon.player, (AbstractDungeon.player.hand.size() / 2) * this.amount, AbstractGameAction.AttackEffect.FIRE));
        }
    }

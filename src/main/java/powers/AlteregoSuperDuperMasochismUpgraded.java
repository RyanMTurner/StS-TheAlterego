...
public class AlteregoSuperDuperMasochismUpgraded extends AbstractPower {
    public AbstractCreature source;

    public static final String POWER_ID = "alterego_mod:SuperDuperMasochismPowerUpgraded";
    ...
    int damageToTrigger = 5;

    public AlteregoSuperDuperMasochismUpgraded(final AbstractCreature owner, final AbstractCreature source) {
        name = NAME;
        ID = POWER_ID;

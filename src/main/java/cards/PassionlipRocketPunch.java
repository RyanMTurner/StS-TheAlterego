...
public class PassionlipRocketPunch
        extends CustomCard {
    public static final String ID = "alterego_mod:RocketPunch";
    private static CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    // Get object containing the strings that are displayed in the game.
    public static final String NAME = cardStrings.NAME;
    public static final String DESCRIPTION = cardStrings.DESCRIPTION;
    public static final String IMG_PATH = "images/cards/Rocket Punch.png";
    private static final int COST = 1;
    private static final int UPGRADE_PLUS_DMG = 3;

    public PassionlipRocketPunch() {
    ...
    public AbstractCard makeCopy() {
        return new PassionlipRocketPunch();
    }

...
public class PassionlipTreatment
        extends CustomCard {
    public static final String ID = "alterego_mod:Treatment";
    ...
    {
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new RegenPower(AbstractDungeon.player, magicNumber), magicNumber));
    }

    @Override
    public AbstractCard makeCopy() {
        return new PassionlipTreatment();
    }

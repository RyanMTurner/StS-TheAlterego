...
public class AlteregoDurgaParticleEffectLeftToRight extends AbstractGameEffect {
    private float x;
    private float y;
    private float vX;
    private float vY;
    ...
    public AlteregoDurgaParticleEffectLeftToRight() {
        ...
        this.x = AbstractDungeon.player.hb.cX + MathUtils.random(-500.0F, -440.0F) * Settings.scale - 32.0F;

...
public class AlteregoDurgaParticleEffectRightToLeft extends AbstractGameEffect {
    private float x;
    private float y;
    private float vX;
    private float vY;
    ...
    public AlteregoDurgaParticleEffectRightToLeft() {
        ...
        this.x = AbstractDungeon.player.hb.cX + MathUtils.random(300.0F, 360.0F) * Settings.scale - 32.0F;

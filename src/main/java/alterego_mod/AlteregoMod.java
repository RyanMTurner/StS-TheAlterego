...
public class AlteregoMod implements EditCharactersSubscriber,
    ...
    public void receiveEditCards() {
        ...
        BaseMod.addCard(new PassionlipTrickOrTreatment());
        BaseMod.addCard(new PassionlipCycle());
    ...
    public void receiveEditKeywords() {
        ...
        if (keywords != null) {
            for (Keyword keyword : keywords) {
                ...
                if (keyword.PROPER_NAME != null && !keyword.PROPER_NAME.isEmpty()) {
                    BaseMod.addKeyword("alterego_mod:", keyword.PROPER_NAME, keyword.NAMES, keyword.DESCRIPTION);
                }
                else {
